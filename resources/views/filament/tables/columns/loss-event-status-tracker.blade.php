@php
    /** @var \App\Models\Tmlostevent $record */
    $record = $getRecord();
    $tracker = \App\Support\LossEventStatusTracker::for($record);
@endphp
...
>
    ...
    <template x-teleport="body">
        <div
            ...
            x-on:click.stop
        >
            <div class="risk-status-backdrop" x-on:click="open = false"></div>
                ...
                <div class="risk-status-header">
                    <div>
                        <div style="font-size: 28px; font-weight: 700; line-height: 1.2;">
                            Tracking Status Loss Event Approval
                        </div>
                        ...
                        <div style="margin-top: 6px; font-size: 14px; opacity: .72;">
                            Taxonomy: {{ $tracker['taxonomy_code'] }}
                        </div>

                        <div style="margin-top: 8px; font-size: 15px; opacity: .88;">
                            {{ $tracker['event_title'] }}
                        </div>
                    </div>
                                    ...
                                    >
                                        ...
                                        <span style="display: block; min-width: 0; flex: 1 1 auto;">
                                            ...
                                            <span style="display:block; margin-top: 10px;">
                                                ...
                                                @else
                                                    <span class="risk-status-badge pending">Belum</span>
                                                @endif
                                            </span>
                                        </span>
                                    </button>
